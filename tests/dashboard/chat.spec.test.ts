...
test('My group component check', async ({ page }) => {
    ...
    await page.getByPlaceholder('Enter messages').click();
    await page.getByPlaceholder('Enter messages').fill('Hello Test Message');
    await page.locator('form').getByRole('button').click();

    // await expect(page.locator('text=Hello Test Message')).toHaveText('Hello Test Message')
